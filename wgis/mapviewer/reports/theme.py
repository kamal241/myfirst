...
class DefaultTheme(object):
    ...
    _s.add(ParagraphStyle(name="WindDirArrowStyle", fontSize=40, textColor=colors.red, fillColor=colors.red, alignment=TA_CENTER))

    arrow_style = _s['WindDirArrowStyle']
